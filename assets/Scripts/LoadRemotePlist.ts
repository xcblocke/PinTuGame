class _LoadRemotePlist {
    ...
    for (var c in i) {
      ...
      if (s.triangles) {
        ...
        for (var y = 0; y < h.length; y += 2) {
          f.vertices.x.push(h[y]);
          f.vertices.y.push(h[y + 1]);
        }
        for (y = 0; y < g.length; y += 2) {
          f.vertices.u.push(g[y]);
          f.vertices.v.push(g[y + 1]);
        }
      }
  ...
  getRemotePlist(e, t) {
    var o = this,
      n = new Set();
    cc.assetManager.loadRemote(e, function (i, a) {
      if (i) return t(i);
      var r = a._$nativeAsset.metadata.realTextureFileName || a._$nativeAsset.metadata.textureFileName;
      r = cc.path.join(cc.path.dirname(e), r);
      cc.assetManager.loadRemote(r, {
        ext: ".png"
      }, function (e, i) {
        if (e) return t(e);
        var r = o.parsePlist(a._$nativeAsset, n, i);
        n.add(a);
        t(null, {
          atlas: r,
          assets: n
