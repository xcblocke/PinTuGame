...
export default class DebugItem extends cc.Component {
  ...
  init(e) {
    ...
    this.btnLabel.string = (null === (t = e.params) || void 0 === t ? void 0 : t.btnLabel) || `gkey_044`;
    ...
    this.inputNode.getComponentsInChildren(cc.EditBox)[0].string = (null === (i = e.params) || void 0 === i ? void 0 : i.editBox) || "";
    if (e.type === DebugType.Watch) {
      this.watchValueFunc = null === (a = e.params) || void 0 === a ? void 0 : a.watchValue;
  ...
  startWatch(e) {
    ...
    this.watchValueFunc && (this.watchTimer = setInterval(function () {
      try {
        ...
        t.watchLabel.string = `gkey_066??&value1==${e.message}`;
      }
    }, e));
  }
  stopWatch() {
