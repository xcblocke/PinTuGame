...
import BaseEventType from "../Utils/BaseEventType";
...
export default class AdManager {
  ...
  playVideoAd(e, t, o = false) {
    ...
    if (this.lastTouchDate && i - this.lastTouchDate < this.interval) e && e();else {
      ...
      if (cc.sys.isBrowser || !cc.sys.isNative || this.noAdTest) e && e();else {
        ...
        if (cc.sys.os == cc.sys.OS_ANDROID) {
          CallAndroid.getInstance().showRewardVideoAd(JSON.stringify(a));
        } else {
          CalliOS.getInstance().showRewardVideoAd(a);
        }
      }
    }
  }
  ...
  showBannerAd(e) {
    ...
    var i = t.height > 2000 ? 1.03 : 1,
      a = 0.9135802469135802 * t.width * i,
      r = 0.25925925925925924 * t.width * i,
      c = t.width / o.width;
    console.log("bannerSize", a, r, c);
    t.width;
    var s = (o.height - e) * c - r,
      l = e * c;
    CallAndroid.getInstance().showBannerAd(0, s, 0, l, a, r);
  }
  clear() {
