...
export default class AdvancedAnimComponent extends cc.Component {
  ...
  setupMoveTween(e, t, o, n) {
    var i = t.startPosition ? cc.v3(t.startPosition.x, t.startPosition.y, 0) : this.node.position.clone(),
      a = cc.v3(t.targetPosition.x, t.targetPosition.y, 0);
    e.to(0, {
      position: i
    }).to(o, {
      position: a
  ...
  setupRotateTween(e, t, o, n) {
    var i,
      a = null !== (i = t.startRotation) && void 0 !== i ? i : this.node.angle,
      r = t.targetRotation;
    e.to(0, {
      angle: a
    }).to(o, {
  ...
  setupScaleTween(e, t, o, n) {
    var i,
      a = null !== (i = t.startScale) && void 0 !== i ? i : new cc.Vec2(this.node.scaleX, this.node.scaleY),
      r = t.targetScale;
    e.to(0, {
      scaleX: a.x,
      scaleY: a.y
  ...
  setupFadeTween(e, t, o, n) {
    var i = -1 == t.startOpacity ? this.node.opacity : t.startOpacity,
      a = t.targetOpacity;
    e.to(0, {
      opacity: i
    }).to(o, {
