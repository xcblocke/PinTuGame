...
export default class NumComp extends cc.Component {
  ...
  fresh(e) {
    var t = this;
    if (e) {
      if ("number" == typeof e) this.node.getComponent(cc.Label).string = e.toString();else if ("string" == typeof e) this.node.getComponent(cc.Label).string = e;else {
        ...
        cc.tween(this._bindTarget).to(o, {
          ...
          progress: function (e, o, n, i) {
            ...
            if (t.action == GameEventType.UPDATE_BALANCE) {
              t.node.getComponent(cc.Label).string = PlayerDataSys.getCashBalanceWithUnit(a, "");
            } else {
              t.action == GameEventType.UPDATE_GOLDBALANCE && (t.node.getComponent(cc.Label).string = PlayerDataSys.getGoldBalanceWithUnit(a, ""));
            }
          }
        }).call(function () {
          if (t.action == GameEventType.UPDATE_BALANCE) {
